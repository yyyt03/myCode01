...
#define API_KEY		"JRWfbZe9+41jV2NLq69/c68pOc1BXb39a3svv2XB1e8=="

#define DEVICE_NAME		"d1"

#define USE_UNI_APP  1
...
extern uint8_t angle; // 在onenet.c顶部声明
...
void Send_Property_Response(int code, const char *msg, int mode_value)
{
    ...
    if (root != NULL)
    {
        ...
        if (json_str != NULL)
        {
            ...
            OneNET_Publish(response_topic, json_str);
