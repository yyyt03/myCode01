...
//	说明：		
//==========================================================
uint1 MQTT_PacketSaveData(const int8 *pid,const char *devid, int16 send_len, int8 *type_bin_head, MQTT_PACKET_STRUCTURE *mqttPacket)
{
	
  char topic_buf[48];
	sprintf(topic_buf,"$sys/%s/%s/thing/property/post",pid,devid);
